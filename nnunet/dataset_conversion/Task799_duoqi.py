...
if __name__ == "__main__":
    ...
    output_folder = "/home/hjf/daima/MAML-main/nnUNet_raw_data_base/nnUNet_raw_data/Task799_duoqi"
    ...
    nii_files_ts_A = subfiles(test_dir1, True, "patient", "nii", True) # 获得test_dir中包含volume，且以nii结尾的数据

    nii_files_ts_V = subfiles(test_dir2, True, "patient", "nii", True)  # 获得test_dir中包含volume，且以nii结尾的数据
