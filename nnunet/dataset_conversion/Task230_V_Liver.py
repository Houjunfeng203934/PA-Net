...
if __name__ == "__main__":
    ...
    train_dir = "/home/hjf/dataset1/guangyi/cc/ct"
    train_dir1 = "/home/hjf/dataset1/guangyi/cc/label"
    test_dir = "/home/hjf/dataset1/guangyi/cc/result"


    output_folder = "/home/hjf/daima/MAML-main/nnUNet_raw_data_base/nnUNet_raw_data/Task230_guangyi"
    ...
    # nii_files_tr_data = subfiles(train_dir, True, "patient", "nii.gz", True) # 获得train_dir中包含volume,且以nii结尾的数据
    # nii_files_tr_seg = subfiles(train_dir1, True, "patient", "nii.gz", True) # 获得train_dir中包含segmen，且以nii结尾的数据
    nii_files_ts = subfiles(test_dir, True, "patient", "nii.gz", True) # 获得test_dir中包含volume，且以nii结尾的数据
