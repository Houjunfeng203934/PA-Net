...
# -i /home/hjf/daima/MAML-main/nnUNet_raw_data_base/data -o /home/hjf/daima/MAML-main/nnUNet_raw_data_base/result -t 500  -f 0 -tr nnUNetTrainerV2
def main():
    ...
    parser.add_argument("--num_threads_preprocessing", required=False, default=8, type=int, help=
    "Determines many background processes will be used for data preprocessing. Reduce this if you "
    "run into out of memory (RAM) problems. Default: 6")

    parser.add_argument("--num_threads_nifti_save", required=False, default=8, type=int, help=
